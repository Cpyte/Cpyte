...
CORPUS: tuple[str, ...] = (
    ...
    "test/test_del_has_getattr.cpy",
    "test/test_del_has_runtime.cpy",
    "test/test_del_has_mem.cpy",
    "test/test_del_has_dyn.cpy",
    "test/test_del_has_ptr.cpy",
    "test/test_del_has_scope.cpy",
    "test/test_del_has_deep.cpy",
    "test/test_del_has_class.cpy",
    "test/test_del_gc_new.cpy",
    "test/test_shadow_has.cpy",
    "test/test_hex_e.cpy",
